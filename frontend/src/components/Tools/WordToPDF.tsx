...
export default function WordToPDF() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const response = await pdfTools.wordToPdf({ docx: docxBase64 })
    ...
    <div className="space-y-6">
      <div className="card">
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          Convert Word documents (DOCX) to PDF format. Preserves formatting, tables, and images.
        </p>
          ...
          <div>
            ...
            {docxFile && (
              <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                Selected: {docxFile.name} ({formatFileSize(docxFile.size)})
              </p>
            )}
          </div>
      ...
      <div className="card">
        ...
        <ul className="space-y-2 text-gray-600 dark:text-gray-400">
          <li className="flex items-start">
            ...
            <span>Maintains document formatting</span>
          </li>
          <li className="flex items-start">
            <span className="mr-2">✓</span>
            <span>Preserves headings and styles</span>
          </li>
          <li className="flex items-start">
            <span className="mr-2">✓</span>
            <span>Converts tables with formatting</span>
          </li>
          <li className="flex items-start">
            <span className="mr-2">✓</span>
          ...
          <li className="flex items-start">
            <span className="mr-2">✓</span>
            <span>Fast and reliable conversion</span>
          </li>
          <li className="flex items-start">
            <span className="mr-2">✓</span>
            <span>Secure - files are not stored</span>
          </li>
        </ul>
      </div>
    </div>
